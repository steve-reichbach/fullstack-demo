...
router.post('/', (req, res) => vasts.addOne(req.body.data).then(data => res.json(data)));

router.put('/update/:id', (req, res) => vasts.updateOne(req.params.id, req.body.data).then(data => res.json(data)));
