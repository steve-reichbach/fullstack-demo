...
router.post('/', (req, res) => keywords.addOne(req.body.data).then(data => res.json(data)));

router.put('/update/:id', (req, res) => keywords.updateOne(req.params.id, req.body.data).then(data => res.json(data)));
